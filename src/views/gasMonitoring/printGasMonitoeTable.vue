<template>
  <div id="printTable">
    <span class="printTitle">气体监测</span>
    <el-table
      id="printTest"
      :data="listData"
      fit
    ...
    >
      ...
      <el-table-column label="员工姓名" width="80px">
        <template slot-scope="scope">
      ...
      <el-table-column label="甲烷" width="50px">
        <template slot-scope="scope">
      ...
      <el-table-column label="一氧化碳" width="50px">
        <template slot-scope="scope">
      ...
      <el-table-column label="氧气" width="50px">
        <template slot-scope="scope">
      ...
      <el-table-column label="温度" width="50px">
        <template slot-scope="scope">
      ...
      <el-table-column label="湿度" width="50px">
        <template slot-scope="scope">
      ...
      <el-table-column label="地点" width="200px">
        <template slot-scope="scope">
