<template>
  <div class="m_tableContent">
    <print-important-staff-table :list-data="staffInfoData"/>
    <div class="m_downHoleTotalPrint">
      <p class="m_areaNum">重点区域人员: {{ pageQuery.total }} 人</p>
...
<script>
import PrintImportantStaffTable from '../print/printImportantStaffTable'
export default {
  name: 'ImportantStaff',
  components: { PrintImportantStaffTable },
  props: {
    staffInfoData: {
      required: true,
      type: Array
